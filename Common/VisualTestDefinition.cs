...
namespace Common
{
    ...
    {
        public PixelFormat SwapChainPixelFormat = PixelFormat.R8G8B8A8_UNorm;
        ...
        public virtual void Initialize(GraphicsBackend backend)
        {
        ...
        public virtual SwapChainDescription CreateSwapChainDescription(uint width, uint height, PixelFormat pixelFormat)
        {
            return new SwapChainDescription()
            {
                Width = width,
