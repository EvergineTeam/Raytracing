...
namespace glTFLoader.Schema
{
    ...
    public class AccessorSparseValues
    {
        ...
        /// <summary>
        /// The index of the bufferView with sparse values. The referenced bufferView cannot have an ARRAY_BUFFER or ELEMENT_ARRAY_BUFFER target.
        /// </summary>
        ...
        /// <summary>
        /// The offset relative to the start of the buffer view in bytes. It must be aligned.
        /// </summary>
