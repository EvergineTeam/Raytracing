...
namespace glTFLoader.Schema
{
    ...
    public class AccessorSparse
    {
        ...
        /// <summary>
        /// Array of indices of size `count` that points to the accessor attributes that deviate from their initialized values. Indices must strictly increase.
        /// </summary>
        [Newtonsoft.Json.JsonRequiredAttribute()]
        ...
        /// <summary>
        /// An array of size `count` times the number of components, storing the displaced accessor attributes pointed to by `indices`. Substituted values must have the same `componentType` and number of components as the base accessor.
        /// </summary>
        [Newtonsoft.Json.JsonRequiredAttribute()]
