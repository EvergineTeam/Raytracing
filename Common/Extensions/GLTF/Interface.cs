...
namespace glTFLoader
{
    public static class Interface
    {
        ...
        /// </summary>
        /// <param name="stream">Readable stream for a glTF/GLB model</param>
        /// <returns><code>Schema.Gltf</code> model</returns>
        ...
        /// </summary>
        /// <param name="stream">Readable stream of a GLB model</param>
        /// <returns>Byte array of the buffer</returns>
        ...
        /// </summary>
        /// <param name="gltfFilePath">Source file path to a glTF/GLB model</param>
        /// <returns>Lambda function to resolve dependencies</returns>
        ...
        /// <returns>A byte array of the buffer</returns>
        ...
        /// <param name="gltfFilePath">The source file path used to load the model</param>
        ...
        /// <param name="model">The <code>Schema.Gltf</code> model containing the <code>Schema.Buffer</code></param>
        /// <param name="bufferIndex">The index of the buffer</param>
        /// <param name="externalReferenceSolver">A user-provided lambda function to resolve external assets</param>
        /// <returns>Byte array of the buffer</returns>
        /// <remarks>
        ...
        /// 
        /// The external reference solver function is called when the buffer is stored in an external file,
        ...
        /// - As stand-alone files.
        /// - As a part of a binary buffer accessed via bufferView.
        /// - Encoded to Base64 within the JSON.
        /// 
        /// The external reference solver function is called when the image is stored in an external file,
        ...
        /// <summary>
        /// Parses JSON-formatted text content
        /// </summary>
        ...
        /// <summary>
        /// Writes a <code>Schema.Gltf</code> model to a writable binary writer and packs all data into the model
        /// </summary>
        /// <param name="model"><code>Schema.Gltf</code> model</param>
        /// <param name="outputFile">GLB output file path</param>
        /// <param name="gltfFilePath">Source file path used to load the model</param>
        /// <param name="glbBinChunk">Optional GLB-stored buffer (BIN data file). If null, then the first buffer URI must point to a BIN file.</param>
        public static void SaveBinaryModelPacked(this Gltf model, string outputFile, string gltfFilePath, byte[] glbBinChunk = null)
        {
            using (Stream stream = File.Create(outputFile))
            using (var wb = new BinaryWriter(stream))
            {
                SaveBinaryModelPacked(model, wb, gltfFilePath, glbBinChunk);
            }
        }
        ...
        /// <param name="gltfFilePath">Source file path used to load the model</param>
        /// <param name="glbBinChunk">Optional GLB-stored buffer (BIN data file). If null, then the first buffer URI must point to a BIN file.</param>
        public static void SaveBinaryModelPacked(this Gltf model, BinaryWriter binaryWriter, string gltfFilePath, byte[] glbBinChunk = null)
        {
            if (model == null) throw new ArgumentNullException(nameof(model));
                ...
                if (model.BufferViews != null)
                {
                    foreach (var bufferView in model.BufferViews)
                    {
                        ...
                        if (!bufferData.TryGetValue(bufferView.Buffer, out data))
                        {
                            ...
                            data = bufferView.Buffer == 0 && glbBinChunk != null
                                        ? glbBinChunk
        ...
        /// <summary>
        /// Converts a self-contained GLB to a glTF file along with associated textures and data
        /// </summary>
        /// <param name="inputFilePath">The glTF binary file (.glb) to unpack</param>
        /// <param name="outputDirectoryPath">The directory where the files will be extracted</param>
        ...
        /// </summary>
        /// <param name="inputGltfFilePath">glTF file (.gltf) to be packed</param>
        ...
        private static Image.MimeTypeEnum? GetMimeType(string uri)
        {
            ...
            if (uri.StartsWith("data:image/ktx;base64,") || uri.EndsWith(".ktx"))
            {
                return Image.MimeTypeEnum.image_ktx;
            }

            if (uri.StartsWith("data:image/ktx2;base64,") || uri.EndsWith(".ktx2"))
            {
                return Image.MimeTypeEnum.image_ktx2;
            }
